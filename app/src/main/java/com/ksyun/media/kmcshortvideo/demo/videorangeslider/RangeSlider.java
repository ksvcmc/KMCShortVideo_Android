package com.ksyun.media.kmcshortvideo.demo.videorangeslider;
...
public class RangeSlider extends ViewGroup {
    ...
    private void notifyRangeChange() {
        if (mRangeChangeListener != null) {
            mRangeChangeListener.onRangeChange(this, mLeftThumb.getRangeIndex(), mRightThumb.getRangeIndex(),
                    mLeftThumb.getX(), mRightThumb.getX());
        }
    }
    ...
    public interface OnRangeChangeListener {
        void onRangeChange(RangeSlider view, int leftPinIndex, int rightPinIndex, float leftX, float rightX);
    }
